...
```{r solucao-34}
  ...
  cidadesValidas <- cidades %>% filter(despesas_municipais %>% despesaValida) %>% filter(idhm %>% idhmValido)

  cidadesValidas %>% ggplot(aes(x = despesas_municipais, y = idhm)) + geom_point(alpha = 0.05)
